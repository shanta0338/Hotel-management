               ...
               <div class="container-fluid d-flex align-items-center justify-content-between">
                    ...
                    <div class="right-menu list-inline no-margin-bottom">
                         ...
                         <div class="list-inline-item dropdown">
                              <a id="adminDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link admin-link dropdown-toggle">
                                   <i class="icon-user"></i> Admin
                              </a>
                              <div aria-labelledby="adminDropdown" class="dropdown-menu dropdown-menu-right simple-dropdown">
                                   <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="dropdown-item logout-simple">
